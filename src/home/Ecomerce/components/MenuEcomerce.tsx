...
export const MenuEcomerce = ({setBuscador,setCarrito,carrito,deleteFiltro,setfiltrosOption,filtrosSelect,filtrosOption,allMarcas,setfiltrosSelect,allPromocion}:props) => {
  ...
  return (
    <>
      ...
      {/* menu mobil */}
      <nav className={`${expands ? 'h-screen ' : 'h-32'} md:hidden transition-all backdrop-blur-2xl z-30 fixed   w-full flex-col items-center gap-5 p-1 border-b flex overflow-hidden`} >
        <div className="w-full flex flex-row justify-between items-center">
          <div className="w-full flex flex-row gap-2">
            {/* boton de cerrar o abrir */} 
            <button onClick={()=>setExpands(!expands)} className="transition-all">
                {expands ? 
                    <svg xmlns="http://www.w3.org/2000/svg" fill="none" viewBox="0 0 24 24" strokeWidth={1.5} stroke="currentColor" className=" w-10 h-10 transition-all">
