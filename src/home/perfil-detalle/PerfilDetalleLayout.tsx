...
export const PerfilDetalleLayout = () => {
  ...
  */
  ...
  const {data:allcomentarios,isLoading:cargandoComentarios,mutate} = useSWR('/api/comentario/all/medic?id='+id,()=>
  ...
  return (
    <section className="w-full h-screen  flex flex-row justify-center overflow-hidden">
      ...
      <section className="w-full h-full flex flex-row items-start  gap-2 overflow-screen">
              ...
              <div className="w-full flex flex-col gap-2">
                ...
                {coment?.succes.map((coment,index)=>(
                  <div key={index} className="border rounded-lg bg-slate-200 p-2">
                    <p className="text-sm text-slate-400">Comentario realizado el dia: {coment.created_at}</p>
        ...
        {/* segunda columna */}
        <section className="sticky mt-0 w-auto h-full flex flex-col gap-2 bg-white overflow-auto ">
