    ...
    <main className='w-full h-full   bg-[#F7F7F7] flex flex-col gap-10'>
      ...
      <div className=' absolute w-full h-full blur-lg'>
        ...
        <div className='w-full flex flex-wrap p-5 z-50 gap-5 justify-center'>
          {/* tarjeta */}
          <button className='w-72 h-[30rem] bg-[#2899CD] rounded-lg flex flex-col hover:scale-110 transition-all' onClick={()=>detalledoc('doc1')} >
      ...
      <section className='relative w-full h-screen justify-center  flex flex-row gap-5 mt-24 bg-gradient-to-r from-[#A0DCF0] to-[#EAFAFF] overflow-hidden '>
        {/* foto doctora */}
